...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements ISysUserService {
	...
	@Override
	public List<SysUser> getUserByDeptAndRole(String departId, String role) {
		return userMapper.getUserByDeptAndRole(departId, role);
	}
	
	@Override
	public List<String> getUserIdsByDeptsAndRole(List<String> departIds, String role) {
		return userMapper.getUserIdsByDeptsAndRole(departIds, role);
	}
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	public SysUser getPresident() {
		return userMapper.getPresident();
	}

	@Override
	public SysUser getChairman() {
		return userMapper.getChairman();
	}
