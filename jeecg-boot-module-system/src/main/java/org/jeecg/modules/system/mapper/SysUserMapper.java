...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return
	 */
	public List<SysUser> getUserByDeptAndRole(@Param("departId")String departId, @Param("role")String role);
	 ...
	 * @return
	 */
	public List<String> getUserIdsByDeptsAndRole(@Param("list") List<String> departIds, @Param("role")String role);
